...
if __name__=="__main__":
    ...
    model = DARTSPretrain(init='xavier', num_inputs=dataset.max_length, input_emb_size_config=[sum([1,2,4,8,16,30])]*dataset.max_length, input_feature_min=dataset.feat_min, input_feat_num=dataset.feat_sizes, l2_weight=0.001, l2_bias=0.001,
                  target_vec_sizes=[1,2,4,8,16,30],mlp=mlp, bn=False, ln=True)
