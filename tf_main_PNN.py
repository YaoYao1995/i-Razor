...
if __name__=="__main__":
    ...
    if pretrain:
        ...
        print("**"*50)
        model = PNNPretrainAndRetrain(init='xavier', num_inputs=dataset.max_length, input_emb_size_config=input_size_config, input_feature_min=dataset.feat_min, input_feat_num=dataset.feat_sizes, l2_weight=0.001, l2_bias=0.001, temperature=0.05,mlp=mlp, bn=False, mode="retrain")
