...
if __name__=="__main__":
    ...
    model = AdafsPretrain(init='xavier', num_inputs=dataset.max_length, input_emb_size_config=[30]*dataset.max_length, input_feature_min=dataset.feat_min, input_feat_num=dataset.feat_sizes, l2_weight=l2, l2_bias=l2, target_vec_sizes=[0,30], temperature=0.05, mlp=mlp, bn=False, ln=True)
   
    # Setup an experiment folder:
    base_dir = "/root/results/"
    model_string_name = "adafs_pretrain"
